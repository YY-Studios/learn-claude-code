---
title: Subagentテンプレート集
description: コードレビュー、テスト、DB、ドキュメント専用のSubagentテンプレート。役割別エージェント設定例。
---

# Subagentテンプレート集

`.claude/agents/` フォルダに入れてすぐ使えるサブエージェント定義ファイルのテンプレートです。

---

## コードレビューエージェント

ファイルの場所: `.claude/agents/code-reviewer.md`
...
ファイルの場所: `.claude/agents/test-writer.md`
...
ファイルの場所: `.claude/agents/db-migrator.md`
...
ファイルの場所: `.claude/agents/doc-writer.md`
