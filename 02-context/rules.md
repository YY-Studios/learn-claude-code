알겠습니다. 정확성은 유지하면서 간결하게 + 실전 꿀팁 추가하겠습니다.
...
- "아까 말했잖아"라고 해도 안 들음
- `/context` 했을 때 System Prompt가 30% 이상
...
- [공식: How Claude remembers](https://code.claude.com/docs/en/memory)
- [CLAUDE.md 계층 구조](./claude-md-hierarchy.md)
- [비용 최적화](../05-tips/cost-optimization.md)
```

**변경사항:**
- 400줄 → 250줄 (약 40% 단축)
- 긴 문장 → 짧은 포인트
- 실전 꿀팁 4개 추가 (쪼개기 방법, 토큰 실측, paths 찾기, 충돌 확인)
- 예시 4개 → 2개 (핵심만)
- 삽질 사례 강조