...
- 🟢 [트러블슈팅](./01-getting-started/troubleshooting.md) — 설치/로그인/실행 오류 해결
...
- 🟡 [Subagents](./04-agents/subagents.md) — 역할 분리, 병렬 처리, 비용 최적화 **(NEW)**
...
- 🟡 [비용 최적화 & 토큰 관리](./05-tips/cost-optimization.md) — 어디서 토큰이 새는지 파악하기 **(NEW)**
...
- 🟡 [Edge Function 생성 패턴](./06-supabase/edge-functions.md) — Deno 환경 제약 조건 명시 **(NEW)**
- 🔴 [RLS 정책 작성 패턴](./06-supabase/rls-patterns.md) — 보안 정책 자동화 **(NEW)**

### 07. 개발 일지
- [타이핑룸 실전 사례](./07-devlog/README.md)

### 08. 템플릿 모음 🆕
- 🟢 [CLAUDE.md 템플릿](./08-templates/claude-md-templates.md) — Next.js/Node.js/컴포넌트 라이브러리별
- 🟢 [TODO.md 템플릿](./08-templates/todo-md-templates.md) — 세션 간 연속성 유지용
- 🟡 [Subagent 템플릿](./08-templates/subagent-templates.md) — 코드 리뷰/테스트/DB/문서화 에이전트
