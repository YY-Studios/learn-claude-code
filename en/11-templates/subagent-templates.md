---
title: Subagent Template Collection
description: Subagent templates dedicated to code review, testing, DB, and documentation. Agent configuration examples by role.
---

# Subagent Template Collection

Ready-to-use subagent definition file templates to place in your `.claude/agents/` folder.

---

## Code Review Agent

File location: `.claude/agents/code-reviewer.md`
...
File location: `.claude/agents/test-writer.md`
...
File location: `.claude/agents/db-migrator.md`
...
File location: `.claude/agents/doc-writer.md`
